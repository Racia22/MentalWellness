        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoctorIDNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientIDNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StressLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescriptionDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_DoctorIDNumber",
                table: "Doctors",
                column: "DoctorIDNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoodLogs_LogDate",
                table: "MoodLogs",
                column: "LogDate");

            migrationBuilder.CreateIndex(
                name: "IX_MoodLogs_MoodScore",
                table: "MoodLogs",
                column: "MoodScore");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_Category",
                table: "Patients",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_Patients_PatientIDNumber",
                table: "Patients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentPlans_StartDate",
                table: "TreatmentPlans",
                column: "StartDate");
